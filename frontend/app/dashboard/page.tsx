...
function RecentlyActive({ groups }: { groups: DashboardActiveGroup[] }) {
  return (
    <div className="bg-zinc-900 border border-zinc-800 rounded-lg">
      <div className="px-4 py-3 border-b border-zinc-800 flex items-center justify-between">
      ...
      {groups.length === 0 ? (
        <p className="px-4 py-6 text-xs text-zinc-600">No groups with last_seen data.</p>
      ) : (
        <div className="divide-y divide-zinc-800">
          {groups.map((g) => (
            <Link
    ...
    return (
      <div className="space-y-6 animate-pulse">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
          <div className="lg:col-span-3 bg-zinc-900 border border-zinc-800 rounded-lg h-96" />
          <div className="lg:col-span-2 bg-zinc-900 border border-zinc-800 rounded-lg h-96" />
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
        ...
        <div className="lg:col-span-2">
          <RecentlyActive groups={data.recently_active} />
        </div>
      </div>
    </div>
  );
      ...
      <header className="border-b border-zinc-800 bg-zinc-950/90 sticky top-0 z-40 backdrop-blur">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 flex items-center gap-6">
          ...
          <nav className="flex items-center gap-4 text-sm text-zinc-400 mt-1.5">
            <Link href="/dashboard" className="text-zinc-200 font-medium">Dashboard</Link>
